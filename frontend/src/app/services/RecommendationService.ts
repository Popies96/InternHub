...
export class RecommendationService {
  private baseUrl = 'http://localhost:8088/internhub/reviews/recommendation fr  ';

  constructor(private http: HttpClient) {}

  getRecommendation(internshipId: number, regenerate: boolean = false): Observable<string> {
